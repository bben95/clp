...
<div className="container relative z-[1]">
  ...
  <div className="w-full lg:w-[505px] text-white lg:block">
    <div
      className="pt-2 pb-[6px] pr-[25px] pl-[15px] border border-white/20 mb-[27px] relative"
    >
    ...
    <div
      className="pt-2 pb-[6px] pr-[25px] pl-[15px] border border-white/20 mb-[27px]"
    >
      <div className="flex items-end justify-between">
        ...
        <div className="min-w-[115px] lg:min-w-[160px]">
          ...
          >
            <div className="relative overflow-hidden">
              <span className="button-content text-black">Buy Course</span>
              <span className="button-content-hover text-black">Buy Course</span>
            </div>
          </a>
        </div>
      </div>
    ...
    <div
      className=" pt-6 px-2 pb-3 border border-white/20 relative block lg:hidden"
    >
      <div className="absolute top-[-4px] left-[-10px]">
        <div
          className="py-1 px-1 bg-white text-[#232423] rounded-[2px] uppercase text-12 font-semibold relative z-[1]"
