    ...
    <main>
     <section className="section-pad overflow-hidden">
        <div className="container">
          ...
          <div
            className="single-course-book rounded-3xl pt-4 px-3 md:px-5 md:pt-5 bg-primary relative mb-[170px]"
          >
            <div
              className="absolute -top-4 -right-3 md:-top-7 md:-right-4 z-20 max-w-[120px] lg:max-w-full"
            >
              <img src={eb} alt="" />
            </div>
            <div className="row relative z-10">
              <div className="px-2 w-full lg:w-2/5 order-2 lg:order-1">
                <div className="course-img overflow-hidden mb-[-110px] rounded-2xl">
                  <img
                    src={o2}
              ...
              <div className="px-2 w-full lg:w-3/5 pb-5">
                ...
                <div className="md:pt-4 flex gap-4 flex-col-reverse md:flex-row">
                  <div className="flex flex-col gap-2 flex-1">
                    <div className="flex gap-2 items-center justify-center">
                      <h3
                        className="text-white font-bold text-[40px] md:text-[50px]"
                      >
                        ₹4,999
                      </h3>
                      <p
                        className="opacity-70 text-white text-24 mb-0 line-through"
                      >
                        ₹9,999
                      </p>
                    </div>
                  ...
                  <div
                    className="w-[2px] bg-white opacity-10  md:block"
                  ></div>

                  <div className="flex flex-col gap-1 flex-1">
                    <div
                      className="border border-white/25 bg-white/[4%] px-2 py-[10px] flex gap-[12px] rounded-lg items-center"
                    >
                      <img src={ni} alt="" />
        ...
        <div className="container">
          <div
            className="bg-[#064132] rounded-2xl py-3 px-[20px] md:px-5 relative overflow-hidden"
          >
            <div
              className="absolute left-0 right-0 mx-auto max-w-[580px] translate-y-[-30%] top-0 z-0 opacity-10"
            >
              <img src={cp} alt="" />
            </div>
            <div
              className="flex items-center relative z-10 flex-wrap justify-center lg:justify-start gap-3"
            >
              <div className="w-full md:w-auto lg:flex-1 text-center lg:text-left">
                <div
                  className="inline-flex items-center p-2 bg-white/10 rounded-lg gap-1 mb-2"
                >
                  <img src={pt} alt="" />

                  <span
                    className="text-lightyellow md:text-14 tracking-[1px] uppercase font-medium"
                  >
              ...
              <div>
                <div className="flex gap-[12px] md:gap-[20px]">
                  <div className="flex flex-col gap-[12px] items-center">
                    <div
                      className="bg-lightyellow rounded-lg p-[12px] md:py-[18px] md:px-2"
                    >
                      <h3
