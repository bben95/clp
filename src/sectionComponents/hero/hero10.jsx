...
import learners from '../../asset/learners.svg';
function Hero10() {
  ...
  return (
    <main className="overflow-hidden">
      ...
      <img
        src={hsp}
        className="absolute top-4 h-[253px] w-[253px] lg:w-[280px] lg:h-[357px] left-[-24%] lg:left-0"
        alt=""
      />
      <div className="container flex lg:flex-row flex-col">
        <div className="lg:w-[75%]">
          <div className="h12 relative">
            <span>Dominate the&nbsp;</span>
            <br />
            <span>Cricket World with my </span>
            <img
              src={fantasy}
              alt=""
              className="inline-block lg:h-[112px] h-[80px] lg:mt-[-36px] top-[7%] lg:absolute left-[48%]"
            />
        ...
        <div className="lg:w-[25%] flex lg:flex-col flex-row justify-between mt-[80px] lg:mt-0">
          <div className="flex flex-col lg:items-end w-1/2 lg:w-full">
            <div className="flex lg:gap-[20px] sm:gap-[14px] gap-[5px]">
              <img src={learners} alt="" className="sm:w-[76px] w-[45px]" />
          ...
          <div className="flex flex-col lg:items-end w-1/2 lg:w-full pl-[36px]">
            ...
            <p className="mt-[14px] font-clashDisplay font-semibold text-black text-16">
              Average ratings
            </p>
          </div>
        </div>
