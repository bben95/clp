    ...
    <section className="section-pad bg-white" id="testimonials">
        <div className="container">
          <div className="mb-[56px]">
            ...
            <div
              className="opacity-70 md:max-w-[765px] text-center mx-auto mt-2 text-16 leading-[1.6]"
            >
          ...
          <div
            className="grid lg:grid-cols-3 grid-cols-1 gap-4 lg:gap-[20px] text-secondary"
          >
            <div className="flex flex-col gap-4 lg:gap-[20px]">
              <div
                className="rounded-2xl bg-cultured py-[40px] px-3 lg:pt-5 lg:pb-[40px] lg:pl-4 lg:pr-[45px]"
              >
                <div className="text-16 leading-[1.5] opacity-70">
                ...
                <div
                  className="flex mt-5 lg:mt-[117px] gap-2 lg:gap-[14px] items-center"
                >
                  <img
                    src={c1}
                    alt=""
                    className="w-5 lg:w-[56px] h-5 lg:h-[56px]"
                  />
                  <div className="flex flex-col">
                    <div className="text-20 tracking-[-0.5px] font-semibold">
                      Ashley Cooper
                    </div>
                    <img
                      src={s5}
               className="flex-shrink-0 mt-1 w-[85px] lg:mt-0"
                      alt=""
                    />
                  </div>
                </div>
              ...
              >
                ...
                <div className="flex mt-5 lg:mt-[117px] gap-[14px] items-center">
                  <img
                    src={c2}
                    alt=""
                    className="w-5 lg:w-[56px] h-5 lg:h-[56px]"
